    ...
    <div className="portal-app auth-screen-container">
      ...
      <style>{`
        .auth-screen-container {
          ...
          background: radial-gradient(circle at top left, #1c2740, #0f172a);
          padding: 20px;
        ...
        .brand-mark {
        background-image: url('https://vietworldgate.com/wp-content/uploads/2023/08/cropped-vietworldgate-1.png');
