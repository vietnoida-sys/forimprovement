...
import {
  LayoutDashboard, Users, UserCog, GraduationCap, BookOpen, FileText,
...
const GROUPS = [
  ...
  },
  {
    label: "CRM",
    items: [
      { to: "/portal/leads", label: "Lead Management", icon: Users },
      { to: "/portal/users", label: "User Management", icon: UserCog },
    ],
  },
  {
    label: "Academics",
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/portal/documents", label: "Documents", icon: FolderCheck },
      { to: "/portal/visas", label: "Visa Management", icon: Plane },
    ],
  },
  {
    label: "Engagement",
    items: [
      ...
      { to: "/portal/communication", label: "Communication Center", icon: MessageSquare },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/portal/financial", label: "Financial Management", icon: Wallet },
      { to: "/portal/activity-logs", label: "Activity Logs", icon: ShieldCheck },
    ],
  },
  {
    label: "Platform",
    items: [
      { to: "/portal/cms", label: "Website CMS", icon: LayoutTemplate },
      { to: "/portal/referral", label: "Referral & Earn", icon: Gift },
      { to: "/portal/ai-features", label: "AI Features", icon: Sparkles },
